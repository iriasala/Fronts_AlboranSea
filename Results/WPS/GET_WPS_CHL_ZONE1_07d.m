...
%% Save data
%==========================================================================
save('WPS_CHL_ZONE1_07d.mat','TIME','CHLZ1v','DATAint','DATAave','DATAstd',...
...
ylabel(gca,'[Chl-{\ita}] (mg m^{-3})', 'fontsize', 10);
...
xlabel(gca,'[Chl-{\ita}] (mg m^{-3})', 'fontsize', 10);  %# Add a label to the left y axis
%..........................................................................
% ylim([0 110]);
...
print(gcf, '-dpng', 'WPS_CHL_ZONE1_07d.png');
%==========================================================================
return