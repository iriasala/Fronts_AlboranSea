...
%..........................................................................
y0 = fillmissing(CFGZ1v,'linear');           % Interpolate missing values
...
xlabel('Year'); ylabel('FGsst (ºC Km^{-1})');
title('Quantile Regression of Weekly FGsst');
grid on;
%==========================================================================
...
%% Save data:
%==========================================================================
save('QR_FGsst_Z1.mat','t','y','intercepts','slopes','ci','sdv','yhat');
%==========================================================================
return