...
%..........................................................................
y0 = fillmissing(CFPZ1v,'linear');           % Interpolate missing values
...
xlabel('Year'); ylabel('FGchl (mg m^{-3})');
title('Quantile Regression of Weekly FGchl');
grid on;
%==========================================================================
...
%% Save data:
%==========================================================================
save('QR_FPchl_Z1.mat','t','y','intercepts','slopes','ci','sdv','yhat');
%==========================================================================
return