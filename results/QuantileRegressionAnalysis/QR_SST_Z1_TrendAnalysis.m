...
%..........................................................................
y0 = fillmissing(SSTZ1v,'linear');           % Interpolate missing values
...
xlabel('Year'); ylabel('SST (ºC)');
title('Quantile Regression of Weekly SST');
grid on;
%==========================================================================
...
%% Save data:
%==========================================================================
save('QR_SST_Z1.mat','t','y','intercepts','slopes','ci','sdv','yhat');
%==========================================================================
return