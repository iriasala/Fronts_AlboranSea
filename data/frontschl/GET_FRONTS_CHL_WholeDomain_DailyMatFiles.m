...
%==========================================================================
% Written by G. Navarro, N. Zarokanellos, I. Hernandez, and I. Sala.
...
%==========================================================================  
dirin  = 'G:\My Drive\RESEARCH\PROJECT CALYPSO\02_DATA\CHL1\Daily\';  
files  = dir(fullfile(dirin, 'L3m_*GSM*.nc'));  
nFiles = length(files);
%==========================================================================  
...
%==========================================================================  
dirout = 'G:\My Drive\RESEARCH\PROJECT CALYPSO\03_RESULTS\04_CED-CHL\MATFILES\';    
%==========================================================================  
...
for i = 1:nFiles
    ...
    chl1 = double(nc_varget(filepath, 'CHL1_mean'));
    CHL1 = interp2(LON,LAT,chl1,X,Y);
    ...
    %% Save data:
    %======================================================================
    save(fullfile(dirout, [fname(1:end-3), '.mat']), '-v7.3', 'X', 'Y', ...
