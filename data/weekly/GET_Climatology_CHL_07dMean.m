...
%--------------------------------------------------------------------------  
compositeMaps = NaN(size(X,1),size(Y,2),nWeeks);  
%--------------------------------------------------------------------------  
...
for i = 1:nWeeks 
    ...
    tempData = NaN(size(X,1),size(Y,2),length(idxList));
...
save('CHL_WholeDomain_TimeSeries_07d.mat', '-v7.3', ...
     'compositeMaps','X','Y','weeklyDates');
%==========================================================================  
return
