...
%--------------------------------------------------------------------------
% Computes FPsst weekly time series for the three subregions of study.
%==========================================================================

%==========================================================================
%% Load CED-SST data
%==========================================================================
load('G:\My Drive\RESEARCH\PAPERS\InPreparation\Fronts_AlboranSea\Data\Weekly\CEDsst_WholeDomain_TimeSeries_07d.mat');
%==========================================================================
...
%==========================================================================
M80map = repmat(M80,[size(compositeFP,1),1,size(compositeFP,2)]);
M80map = permute(M80map,[1,3,2]);
FPmaps = compositeFP .* M80map;
%==========================================================================
...
%% Save data:  
%==========================================================================  
save('FPsst_Vector_TimeSeries_07dMean.mat','-v7.3',...
